...
<body>
	<section class="content ng-scope" ng-app="cbApp">
			<%
				...
				String sql1="Select * from college order by review DESC";
				...
				Double rate = rs1.getDouble("review");
		%>
	    <div class="big-image header-image" style="background-image: url(<%=imageurl %>);" lazy-img-container="" lazy-img="<%=imageurl %>">
        ...
        <div class="collections-heading-container">
            ...
            <h1 class="collections-heading">
                ...
                <br>
                <!-- ngIf: isRatingSpecific -->
                <span ng-if="isRatingSpecific" class="rating-criteria-header-text ng-binding ng-scope"> based on student ratings </span><br>
    ...
    <div class="container container-body container-collection">
        <!-- ngIf: isRatingSpecific -->
        <h4 ng-if="isRatingSpecific" class="heading-top-collections collection-heading stream-specific-heading ng-scope"> BASED ON STUDENT RATINGS </h4>
        <!-- end ngIf: isRatingSpecific -->
        <div class="row">
				...
				<div class="container container-body container-collection">
					<div class="row">
						...
						<div class="collection-boxes ng-scope"
							...
							String sql="Select * from college order by review DESC";
							...
							while(rs.next())
								{
									...
									double rate = rs.getDouble("review");
							%>
